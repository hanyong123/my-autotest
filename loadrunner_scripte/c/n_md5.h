...
static void MD5Transform PROTO_LIST ((UINT4 [4], unsigned char const [64]));
static void Encode PROTO_LIST
  ((unsigned char *, UINT4 *, unsigned int));
static void Decode PROTO_LIST
  ((UINT4 *, unsigned char const*, unsigned int));
 ...
 */
void oemMD5Init (context)
oemMD5_CTX *context;                                        /* context */
{
...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
void oemMD5Update (context, input, inputLen)
oemMD5_CTX *context;                                        /* context */
 ...
 */
void oemMD5Final (digest, context)
...
*/
  ...
  oemMD5Update (context, PADDING, padLen);

  /* Append length (before padding) */
  oemMD5Update (context, bits, 8);
